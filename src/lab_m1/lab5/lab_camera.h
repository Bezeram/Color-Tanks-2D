...
namespace implemented
{
    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0f), angle, glm::vec3(1, 0, 0)) * glm::vec4(forward, 1.0f)));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            right = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 0, 1)) * glm::vec4(right, 1.0f)));
            up = glm::normalize(glm::cross(right, forward));
        }
